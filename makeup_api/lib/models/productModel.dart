...
// ignore_for_file: constant_identifier_names, unnecessary_null_comparison, prefer_if_null_operators, unnecessary_new, prefer_conditional_assignment, file_names, prefer_null_aware_operators
...
String productToJson(List<Product> data) =>
    ...
    //
List<ProductColor> productColorFromJson(String str) =>
    List<ProductColor>.from(json.decode(str).map((x) => ProductColor.fromJson(x)));

String productColorToJson(List<ProductColor> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
    //
